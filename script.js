...
function clearAll() {
const memeClear = document.querySelector('.meme-content')
const jokeClear = document.querySelector('.joke-content')
const quoteClear = document.querySelector('.quote-content')
const riddleClear = document.querySelector('.riddle-content')
memeClear.textContent = '';
jokeClear.textContent = '';
quoteClear.textContent = '';
riddleClear.textContent = '';
}
...
clearAll();
memeContent.appendChild(newImg)
}
...
answerP.textContent = 'The Answer is : ' + answer;
answerP.setAttribute('id', 'answerId')//this will create <p> with id = answerId
answerP.hidden = true;

clearAll()
const riddle = document.querySelector('.riddle-content')
riddle.appendChild(questionP)
riddle.appendChild(answerP)
}
...
alert('already riddle answer');
} else{
alert('riddle answer tooooooo');
}
}
